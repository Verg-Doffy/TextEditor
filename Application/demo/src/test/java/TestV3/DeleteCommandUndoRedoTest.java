...
public class DeleteCommandUndoRedoTest {
    ...
    void testdeleteCommandUndoRedo() {
        ...
        // verify state after commands executuion
        ...
        // change the selection before deletion
        ...
        invoker.executeCommand("undo");
        assertEquals("Merci Beaucoup", engine.getBufferContents(), "Buffer should contain ''");
        assertEquals("", engine.getClipboardContents(), "Clipboard should contain ''");
        ...
        invoker.executeCommand("redo");
        assertEquals("Merci Beaucoup", engine.getBufferContents(), "Buffer should contain ' Beaucoup'");
        assertEquals("", engine.getClipboardContents(), "Clipboard should contain ''");
        assertEquals(0, engine.getSelection().getBeginIndex(), "begin index should be at 0");
        assertEquals(0, engine.getSelection().getEndIndex(), "end index should be at 0");
